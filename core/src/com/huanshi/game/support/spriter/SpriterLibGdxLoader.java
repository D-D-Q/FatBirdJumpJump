...
/**
 * 载入Spriter的资源图，并把分散的资源图打包成TextureAtlas使用，节省内存
 * 
 * @date 2017年3月4日 下午9:01:15
 */
public class SpriterLibGdxLoader extends Loader<Sprite> implements Disposable{
	...
	public SpriterLibGdxLoader(Data data){
		this(data, true);
	}
	
	public SpriterLibGdxLoader(Data data, boolean pack){
		this(data, standardAtlasWidth, standardAtlasHeight);
		this.pack = pack;
	}

	public SpriterLibGdxLoader(Data data, int atlasWidth, int atlasHeight) {
		super(data);
		this.pack = true;
